	...
	public class LunghezzaNome extends Exception {
	    public LunghezzaNome(String campo) {
	        super("Il campo \"" + campo + "\" deve contenere almeno 3 caratteri.");
	    }
	    
	    public LunghezzaNome(String campo, String s) {
	    	super("il campo \"" + campo + "\" " + s);  
	    }
	}
